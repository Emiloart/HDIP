...
- reusable KYC credential artifacts
...
- persistence leakage of sensitive KYC claims or signed credential artifacts
...
- tests that status and trust-registry lookups affect verifier decisions deterministically
